 ...
 * @property {string} gustoToken - The Github token of the user
 */
...
export class ConnectionModelService {
  ...
  async upsertConnection(userId, attributes) {
    ...
    try {
      ...
      return { userId, mondayToken, gustoToken };
    } catch (err) {
